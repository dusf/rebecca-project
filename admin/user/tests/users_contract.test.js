...
assert.match(html, /href="css\/users\.css\?v=10"/);
...
assert.match(html, /src="js\/user_components\.js\?v=2"/);
assert.match(html, /src="js\/users\.js\?v=9"/);
assert.match(userFormHtml, /href="css\/users\.css\?v=10"/);
assert.match(userFormHtml, /src="js\/user_components\.js\?v=2"/);
