    ...
    const SIDEBAR_MENU = [
      ...
      },
      {
        ...
        items: [
          ...
          { page: 'reviews', label: '评价',
            icon: '<svg viewBox="0 0 24 24"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7A8.38 8.38 0 0 1 4 11.5 8.5 8.5 0 0 1 8.7 3.9 8.38 8.38 0 0 1 12.5 3h.5a8.48 8.48 0 0 1 8 8v.5z"/><path d="m12 7 .93 2.87H16l-2.52 1.77.96 2.86L12 12.73 9.56 14.5l.96-2.86L8 9.87h3.07z"/></svg>' },
          { page: 'points', label: '积分',
            icon: '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M9 9h3.5a1.5 1.5 0 0 1 0 3H11.5a1.5 1.5 0 0 0 0 3H15"/><path d="M12 7v10"/></svg>' },
          { page: 'recommend', label: '推荐',
            icon: '<svg viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M19 8v6M16 11h6"/></svg>' },
          { page: 'international', label: '国际化',
