...
(function () {
  ...
  var recommendData = [
    { name: 'NOIRÉ 13x4 透明蕾丝前额假发', image: IMG_PREFIX + 'product-1.png', price: 189.99, oldPrice: 239.99 },
    { name: 'NOIRÉ HD 5x5 闭合式蕾丝假发', image: IMG_PREFIX + 'product-2.png', price: 229.99, oldPrice: 279.99 },
    { name: 'NOIRÉ 全手织蕾丝前额假发', image: IMG_PREFIX + 'product-3.png', price: 299.99, oldPrice: 359.99 },
    { name: 'NOIRÉ 直发水波纹假发', image: IMG_PREFIX + 'product-4.png', price: 259.99, oldPrice: 309.99 },
    { name: 'NOIRÉ 深卷波浪假发', image: IMG_PREFIX + 'product-5.png', price: 279.99, oldPrice: 329.99 }
  ];
