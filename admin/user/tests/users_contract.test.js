...
assert.match(adminIndex, /common\/css\/user_dialogs\.css\?v=16/);
assert.match(adminIndex, /common\/js\/user_dialog\.js\?v=18/);
...
assert.match(html, /href="css\/users\.css\?v=23"/);
...
assert.match(html, /src="js\/users\.js\?v=25"/);
