...
var PLATFORM_SIDEBAR_MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { page: 'logistics-provider', label: '物流商',
        icon: '<svg viewBox="0 0 24 24"><path d="M1 3h15v13H1z"/><path d="M16 8h4l3 3v5h-7"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>' },
      { page: 'logistics-channel', label: '物流渠道',
        icon: '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/><path d="M8 12h8"/><path d="M6 3h12"/><path d="M6 21h12"/></svg>' },
      { page: 'channel-cost', label: '渠道成本',
        icon: '<svg viewBox="0 0 24 24"><rect x="2" y="4" width="20" height="16" rx="2"/><line x1="12" y1="1" x2="12" y2="23"/><path d="M6 10h4"/><path d="M6 14h2"/><path d="M15 10h3"/><path d="M15 14h3"/></svg>' },
...
var PLATFORM_PAGE_CONFIG = {
  ...
  'zone':          'parameters/zone/zone.html',
  'country':       'parameters/country/country.html',
  'region':        'parameters/region/region.html',
  'language':      'parameters/language/language.html',
  'currency':      'parameters/currency/currency.html',
  'exchange-rate': 'parameters/exchange_rate/exchange_rate.html',
  'tax-rate':      'parameters/tax_rate/tax_rate.html',
  'logistics-provider': 'parameters/logistics_provider/logistics_provider.html',
  'logistics-channel':  'parameters/channel/channel.html',
  'channel-cost':  'parameters/channel_cost/channel_cost.html',
  'vip':           'parameters/vip/vip.html',
  'category':      'parameters/category/category.html',
...
var PLATFORM_BREADCRUMB_CONFIG = {
  ...
  'tax-rate':      ['通用参数', '税率'],
  'logistics-provider': ['通用参数', '物流商'],
  'logistics-channel':  ['通用参数', '物流渠道'],
  'channel-cost':  ['通用参数', '渠道成本'],
  'vip':           ['通用参数', 'VIP体系'],
  'category':      ['通用参数', '分类'],
