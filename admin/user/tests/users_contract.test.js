...
assert.match(html, /href="\.\.\/common\/css\/commons\.css\?v=5"/);
assert.match(html, /href="css\/users\.css\?v=14"/);
...
assert.match(userFormHtml, /src="js\/user_form\.js\?v=3"/);
...
assert.match(productListHtml, /href="\.\.\/common\/css\/commons\.css\?v=5"/);
